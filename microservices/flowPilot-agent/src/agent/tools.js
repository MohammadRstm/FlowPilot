...
export function createTools() {
  return [
    ...
    new DynamicTool({
      ...
      description: "Return the schema of an n8n node including inputs, outputs, fields and credentials. This tool MUST only be called at its correct step in the pipeline.",
      func: async (node) =>
    ...
    new DynamicTool({
      ...
      description: "Generate a valid n8n workflow JSON using intent, examples, and schemas. This tool MUST only be called at its correct step in the pipeline.",
      func: async (context) =>
